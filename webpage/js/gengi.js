...
$('#isk').on('input', function(){
	$('#usd').val((Math.round(($(this).val() / 129.37) * 100) / 100).toString());
	$('#gbp').val((Math.round(($(this).val() / 197.34) * 100) / 100).toString());
	$('#eur').val((Math.round(($(this).val() / 140.48) * 100) / 100).toString());
	$('#jpy').val((Math.round(($(this).val() / 1.06) * 100) / 100).toString());
});
